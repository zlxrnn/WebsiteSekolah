      ...
      <div class="flex flex-col h-full m-10">
        ...
        <div class="overflow-x-auto max-h-96">
          <table class="border-collapse w-full">
            ...
            <tbody>
              ...
              $search_query = "";
              $count_query = "SELECT COUNT(*) as total FROM mapel";
              $data_query = "SELECT * FROM mapel";
              
              if(isset($_GET['search']) && !empty($_GET['search'])) {
                $search_term = mysqli_real_escape_string($conn, $_GET['search']);
                $search_condition = " WHERE mapel LIKE '%$search_term%'";
              ...
              if ($data && mysqli_num_rows($data) > 0) {
                    ...
                    <tr class="border-solid border h-22 transition-all duration-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-4 text-center">
                            <div class="flex gap-3 justify-center">
                              ...
                              <a href="hapus.php?id=<?= $d['id']; ?>" onclick="return confirm('Are you sure you want to delete this subject?')" class="abtn flex w-14 rounded-full h-13 justify-center items-center bg-red hover:bg-red-dark transition-colors">
                ...
                <tr>
                  <td colspan="4" class="py-4 px-4 text-center text-gray-500">
                    <?= isset($_GET['search']) ? 'No subjects found for "' . htmlspecialchars($_GET['search']) . '"' : 'No data available' ?>
                  </td>
                </tr>
                <?php
              }
        ...
        <div class="flex justify-between items-center mt-4 px-6">
          ...
          <div class="flex gap-3">
            <?php if ($page > 1): ?>
              <!-- PERBAIKAN: Tambahkan parameter search di pagination -->
