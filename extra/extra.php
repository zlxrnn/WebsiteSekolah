...
<html lang="en">
  <head>
    ...
    <title>Extraculliculer - Dashboard</title>
  </head>
  <body>
    <div class="flex gap-5">
      ...
      <div class="flex flex-col h-full m-10">
        ...
        >
          <h1 class="text-5xl font-black">EXTRACULLICULER</h1>
        </div>
        ...
        <div class="overflow-x-auto max-h-96">
          <table class="border-collapse w-full">
            <thead>
              <tr class="border border-solid rounded-[10px] h-22 bg-primary sticky top-0 ">
                  <th class="text-white py-3 px-4 text-center">NO</th>
                  <th class="text-white py-3 px-4 text-center">EXTRACURRICULAR</th>
                  <th class="text-white py-3 px-4 text-center">DAY</th>
                  <th class="text-white py-3 px-4 text-center">TIMETABLE</th>
                  <th class="text-white py-3 px-4 text-center">EXTRACURRICULAR TEACHER</th>
            ...
            <tbody>
              ...
              $search_query = "";
              $count_query = "SELECT COUNT(*) as total FROM ekstra";
              $data_query = "SELECT * FROM ekstra";
              
              if(isset($_GET['search']) && !empty($_GET['search'])) {
                $search_term = mysqli_real_escape_string($conn, $_GET['search']);
                $search_condition = " WHERE nama LIKE '%$search_term%' OR guru LIKE '%$search_term%'";
