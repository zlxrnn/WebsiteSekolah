...
<html lang="en">
  <head>
    ...
    <title>Edit Teacher - Dashboard</title>
    ...
    <div class="flex gap-5">
      <!-- SideBar -->
        ...
        >
          ...
          <a href="../teacher/teacher.php" class="flex items-center w-full gap-3 duration-300 cursor-pointer px-5 py-7 bg-[var(--color-secondary)] hover:bg-[var(--color-accent)]">
      ...
      <div class="flex flex-col h-full m-10">
        ...
        >
          <h1 class="text-5xl font-black text-primary">EDIT TEACHER</h1>
        </div>
        <div
          ...
          <div class="flex flex-col w-full">
            ...
            >
              <div class="relative w-full my-3">
                <label class="my-2 text-primary">NIP</label>
                <input
                  type="number"
                  id="nip"
                  name="nip"
              ...
              <div class="relative w-full my-3">
                <label class="my-2 text-primary">Subject</label>
                <select
                  name="mapel"
                  required
